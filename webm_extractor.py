...
WebmThread = namedtuple('WebmThread', 'thread_info webm_url thread_title')
...
def get_webm_posts(posts):
    return [ post for post in posts if ('ext' in post and post['ext'] == '.webm') ]
